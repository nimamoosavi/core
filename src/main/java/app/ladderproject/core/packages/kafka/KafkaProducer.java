...
public interface KafkaProducer {
     ...
     * ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG etc. but some key is required to connect to kafka
     */
    ProducerFactory<String, Object> producerFactory(Map<String, Object> configs);

    /**
     * @param topic of kafka that you must import it
     * @param o     object that serializes and push it to kafka server
     ...
     * @apiNote you must know method not call server Async, and it can delay for get response, but you can manage a result of kafka
     */
