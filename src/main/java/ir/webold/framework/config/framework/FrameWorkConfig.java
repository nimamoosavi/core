...
@PropertySource(value = "classpath:/applicationConfig.properties", encoding = "UTF-8", ignoreResourceNotFound = true)
@PropertySource(value = "classpath:/redisConfig.properties", encoding = "UTF-8", ignoreResourceNotFound = true)
@PropertySource(value = "classpath:/kafkaConfig.properties", encoding = "UTF-8", ignoreResourceNotFound = true)
