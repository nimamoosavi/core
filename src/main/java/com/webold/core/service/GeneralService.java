...
import com.webold.core.repository.GeneralRepository;
import com.webold.core.utility.ApplicationException;
import com.webold.core.utility.ApplicationResource;
...
import com.webold.core.mapper.GeneralMapper;
import com.webold.core.utility.ApplicationPagination;
...
public abstract class GeneralService<T extends BaseEntity<I>, S, R, I extends Serializable> {
    ...
    public BaseDTO<List<R>> save(List<S> sList) {
        ...
        return mapListEntityToResponse(save);
    }
