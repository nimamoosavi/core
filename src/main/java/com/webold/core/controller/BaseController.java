...
public abstract class BaseController<T extends BaseEntity<I>, S, R, I extends Serializable> {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = GeneralStatic.AUTHORIZATION, value = GeneralStatic.AUTHORIZATION, required = true, dataType = "string", paramType = "header"),
            @ApiImplicitParam(name = GeneralStatic.APP_KEY, value = GeneralStatic.APP_KEY, required = true, dataType = "string", paramType = "header")})
    @PostMapping
